...
public class LinkedList : IEnumerable<int>
{
    ...
    {
        // Problem 3 - Remove node containing value
        Node? curr = _head;
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                return; // Exit after removing the first instance
            }
            curr = curr.Next;
        }
    }
    ...
    {
        // Problem 4 - Replace all occurrences of oldValue
        Node? curr = _head;
        while (curr is not null)
        {
    ...
    {
        // Problem 5 - Reverse iteration from tail to head
        var curr = _tail;
        while (curr is not null)
        {
